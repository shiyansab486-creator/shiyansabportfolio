...
const renderCanvas = ({
  ...
  const currentText = (framerProps.texts || ["Next.js", "React"])[currentTextIndex] || "Next.js";
...
const createParticles = (
  ...
  if (text === "SHIYAN SAB") {
    const colors = ["#FFFFFF", "#3B82F6", "#8B5CF6", "#FFFFFF", "#D4AF37", "#3B82F6", "transparent", "#8B5CF6", "#FFFFFF", "#D4AF37"];
    ctx.textAlign = "left";
    let currentX = textLeft;
